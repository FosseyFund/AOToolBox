...
##h1("Animal Observer data editor"),
    ...
    #fluidRow(column(3, verbatimTextOutput("value"))),
  	...
  	# downloadButton("downloadScansView", "Download scans", icon=icon('download'), style="color: #090909; background-color: #cdcdcd; border-color: #090909"),
  		HTML("<div style='background-color:rgba(63, 174, 191, 0.60); text-align:center; vertical-align: middle; padding:40px 0;'><h2> Sessions </h2></div>"),
    ...
    hr(),
    hr(),
    HTML("<div style='background-color:rgba(63, 174, 191, 0.30); text-align:center; vertical-align: middle; padding:40px 0;'><h4> Session variables </h4></div>"),
    ...
    br(),
    	...
    	br(),
    HTML("<div style='background-color:rgba(104, 191, 63, 0.60); text-align:center; vertical-align: middle; padding:40px 0;'><h2> Focal samples </h2></div>"),
   ## HTML("<h3><b>    Focal samples</b></h3>"),
    ...
    hr(),
    hr(),
    HTML("<div style='background-color:rgba(104, 191, 63, 0.30); text-align:center; vertical-align: middle; padding:40px 0;'><h4> Dyadic and self-directed/health data </h4></div>"),
    ...
    hr(),
    hr(),
    HTML("<div style='background-color:rgba(104, 191, 63, 0.30); text-align:center; vertical-align: middle; padding:40px 0;'><h4> Focal comments </h4></div>"),
    ...
    hr(),
    hr(),
    HTML("<div style='background-color:rgba(104, 191, 63, 0.30); text-align:center; vertical-align: middle; padding:40px 0;'><h4> Background taps </h4></div>"),
    ...
    hr(),
    hr(),
    HTML("<div style='background-color:rgba(104, 191, 63, 0.30); text-align:center; vertical-align: middle; padding:40px 0;'><h4> Focal variables </h4></div>"),
    ...
    hr(),
    hr(),
    HTML("<div style='background-color:rgba(104, 191, 63, 0.30); text-align:center; vertical-align: middle; padding:40px 0;'><h4> Continuous variables variables </h4></div>"),
   ##HTML("<h4><b>    Continuous variables variables</b></h3>"),
    ...
    HTML('<hr style="height:2px;border:none;color:#333;background-color:#333;" />'),
    br(),
    HTML("<div style='background-color:rgba(237, 158, 22, 0.60); text-align:center; vertical-align: middle; padding:40px 0;'><h2> Scan samples </h2></div>"),
    ...
    hr(),
    hr(),
    HTML("<div style='background-color:rgba(237, 158, 22, 0.30); text-align:center; vertical-align: middle; padding:40px 0;'><h4> Scan variables </h4></div>"),
    ...
    hr(),
    hr(),
    HTML("<div style='background-color:rgba(237, 158, 22, 0.30); text-align:center; vertical-align: middle; padding:40px 0;'><h4> Scan data </h4></div>"),
